...
<head>
    ...
    <meta name="keywords" content="samy, electronics, samy electronics, shop, gondar, ">
...
<body class="">
    <nav class="navbar navbar-expand-lg fixed-top bg-light py-0">
        <div class="container">
            ...
            <section class="navbar-mobile">
                <nav class="nav nav-navbar ml-auto">
                    ...
                    <a class="nav-link" href="{{route('all')}}">Products</a>
        ...
        <div class="container">
            <div class="row gap-y">
                ...
                <div class="col-xl-6 order-md-first">
                    ...
                    <p>“Get Latest Online Gadgets at Samy Electronics where you can get latest barber products, screen protector, selfie sticks and much more home equipment at affordable prices.”</p>
